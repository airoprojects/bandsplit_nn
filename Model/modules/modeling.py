...
class RNNModule(nn.Module):
    ...
    def __init__(self, input_dim_size, hidden_dim_size, rnn_type = 'lstm', bidirectional= True):
...
class BandSequenceModelModule(nn.Module):
    ...
    def __init__(self, input_dim_size, hidden_dim_size, rnn_type = 'lstm', bidirectional = True, num_layers = 12):
